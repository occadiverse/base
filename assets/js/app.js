    ...
    bottomContainer.innerHTML = leftWidgetHtml + rightWidgetHtml;
        ...
        setTimeout(() => {
            window.updateDynamicSelectors(); window.applyFilters(); window.updateDashboard(); window.renderPlayerRoster();
            window.recalculateOppmoteAndKjemi(); window.renderCalendar(); window.switchTab('hjem');
        }, 300);
